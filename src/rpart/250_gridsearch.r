...
setwd("C:/Users/Diego/Google Drive (diegodelucag@gmail.com)/Maestria_Data_Science/DM_EyF")  #Establezco el Working Directory

ksemillas  <- c(589481,101504, 310597, 100519,200920,208202) #reemplazar por las propias semillas
...
for( vminsplit in  c(2,4, 8, 10, 15, 20, 30, 50, 100 ) )
for( vminbucket  in  unique( as.integer(c(1,2,3,4,5,  vminsplit/10, vminsplit/5 )) ) )
        
      {
        ...
        E252  <- c( param_basicos,  list( "ganancia" = gan ) )
        loguear( E252 )
      }

...
particionar( dataset, division=c(70,30), agrupa="clase_ternaria", seed= 589481)  #Cambiar por la primer semilla de cada uno !
...
# pdf(file ="./work/MiPrimerArbol_03.pdf",paper="usr" )

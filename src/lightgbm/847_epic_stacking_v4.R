...
kexperimento  <- 1044   #NA si se corre la primera vez, un valor concreto si es para continuar procesando

kscript         <- "847_epic_stacking_v4"
...
hs <- makeParamSet( 
         ...
         makeIntegerParam("num_leaves",       lower=    8L   , upper= 4000L),

         #Agrego los que estaban fijos
         makeIntegerParam("max_depth",        lower=    4L   , upper= 20L),    
         ...
         makeIntegerParam("max_bin",           lower=    5L   , upper= 255L),

...
#---Cambios----------------------------------------------------------------------
#pruebo hacer algo que generalice mucho: max_bin chico y arboles con pocas hojas y grandes
#CON regularización
#corre sobre dataset diego&clara
...
kexperimento  <- 103302   #NA si se corre la primera vez, un valor concreto si es para continuar procesando
...
hs <- makeParamSet( 
         ...
         makeIntegerParam("num_leaves",       lower=    20L   , upper= 80L),

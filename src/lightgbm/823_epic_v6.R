...
seetwd("C:/Users/Diego/diegodelucag_gmail/Maestria_Data_Science/DM_EyF")
kexperimento  <- 103901   #NA si se corre la primera vez, un valor concreto si es para continuar procesando
...
hs <- makeParamSet( 
  ...
  makeNumericParam("feature_fraction", lower=    0.25  , upper=    0.79), 
  ...
  makeNumericParam("min_gain_to_split",lower=    2.5  , upper=    5.0),
  makeNumericParam("lambda_l1",        lower=    0.01   , upper= 5), 
  makeNumericParam("lambda_l2",        lower=    30L   , upper= 200L),
  makeNumericParam("bagging_fraction", lower=    0.6  , upper=    0.85),  
  makeIntegerParam("bagging_freq",        lower=    50L   , upper= 120L),
  makeNumericParam("prob_corte", lower=    0.03  , upper=    0.055)  
)

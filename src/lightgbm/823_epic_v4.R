...
#setwd("/home/rstudio/Diego/diegodelucag_gmail/Maestria_Data_Science/DM_EyF")
setwd("C:/Users/Diego/diegodelucag_gmail/Maestria_Data_Science/DM_EyF")


kexperimento  <- 1038   #NA si se corre la primera vez, un valor concreto si es para continuar procesando
...
hs <- makeParamSet( 
         makeNumericParam("learning_rate",    lower=    0.05 , upper=    0.13),  
         makeNumericParam("feature_fraction", lower=    0.3  , upper=    0.95), 
         makeIntegerParam("min_data_in_leaf", lower=  1500L   , upper= 3000L), 
         makeIntegerParam("num_leaves",       lower=    400L   , upper= 6000L),  
         makeIntegerParam("max_depth",        lower=    3L   , upper= 12L),    
         makeNumericParam("min_gain_to_split",lower=    0.01  , upper=    3.0),
         makeIntegerParam("lambda_l1",        lower=    0L   , upper= 10L), 
         makeIntegerParam("lambda_l2",        lower=    35L   , upper= 140L),
         makeNumericParam("bagging_fraction", lower=    0.6  , upper=    0.9),  
         makeIntegerParam("max_bin",        lower=    5L   , upper= 31L),
...
ksemilla_azar  <- 288313  #Aqui poner la propia semilla
#------------------------------------------------------------------------------

...
kexperimento  <- 1043   #NA si se corre la primera vez, un valor concreto si es para continuar procesando
...
hs <- makeParamSet( 
         ...
         makeIntegerParam("max_depth",        lower=    4L   , upper= 16L),    
         ...
         makeNumericParam("bagging_fraction", lower=    0.2  , upper=    0.8),  
         makeIntegerParam("bagging_freq",        lower=    50L   , upper= 100L)
         )

...
karch_generacion  <- "./datasets/paquete_premium_202009_v1.csv"
karch_aplicacion  <- "./datasets/paquete_premium_202011_v1.csv"
...
hs <- makeParamSet( 
          ...
          makeIntegerParam("min_data_in_leaf", lower= 1800    , upper= 5500),
          makeIntegerParam("num_leaves",       lower=16L   , upper= 600L),
          makeIntegerParam("max_depth",       lower=-1L   , upper= 12L),
          makeNumericParam("min_gain_to_split", lower= 0.1  , upper=  5.0),

...
#directory.root  <-  "~/buckets/buko_yoni666/"  #Google Cloud
#setwd( directory.root )

setwd("G:/Mi unidad/Maestria_Data_Science/DM_EyF/dmeyf")
...
CanaritosImportancia  <- function( dataset )
{
  ...
  entrenamiento  <-  dataset[ , foto_mes>= 201801 &  foto_mes<= 202010 &  foto_mes!=202006 & ( clase01==1 | azar < 0.10 ) ]

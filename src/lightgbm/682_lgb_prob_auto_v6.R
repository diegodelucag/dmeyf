...
#Espacios de búsqueda de params diferentes 
...
karch_generacion  <- "./datasets/paquete_premium_202009_v2.csv"
karch_aplicacion  <- "./datasets/paquete_premium_202011_v2.csv"
...
hs <- makeParamSet( 
  ...
  makeIntegerParam("min_data_in_leaf", lower= 3000    , upper= 5000),
  makeIntegerParam("num_leaves",       lower=600L   , upper= 6000L),
  makeIntegerParam("max_depth",       lower=12L   , upper= 16L),
  makeNumericParam("min_gain_to_split", lower= 0.0  , upper=  0.25),
  makeNumericParam("lambda_l1", lower= 0.0  , upper=    0.4999999),
  makeNumericParam("lambda_l2", lower= 1.09  , upper=    3.0)
)

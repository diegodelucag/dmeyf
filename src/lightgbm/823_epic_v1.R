...
#Agrego dos parametros de bagging para que subseleccione filas además de columnas (feature_fraction)
#-------------------------------------------------------------------------------
...
hs <- makeParamSet( 
         ...
         makeIntegerParam("num_leaves",       lower=    4L   , upper= 5000L),
         makeIntegerParam("max_depth",        lower=    3L   , upper= 12L),
         makeNumericParam("min_gain_to_split",lower=    0  , upper=    15.0),

...
kexperimento  <- 1040   #NA si se corre la primera vez, un valor concreto si es para continuar procesando
...
hs <- makeParamSet( 
  ...
  makeIntegerParam("min_data_in_leaf", lower=  3000L   , upper= 8000L), 

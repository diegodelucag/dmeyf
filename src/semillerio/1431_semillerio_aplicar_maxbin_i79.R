...
karch_dataset  <- "./datasets/dataset_epic_0020.csv.gz" ### FIJATE EL NOMBRE QUE LE PUSISTE AL DATASET
ksalida  <- "semillerio" 
...
x  <- list()
x$gleaf_size   <-  80.18751
x$gnum_leaves  <-  0.48154
x$learning_rate <-  0.036742
x$feature_fraction <-  0.439245
x$max_bin  <-  156
x$num_iterations  <-149.6   
x$pos_ratio  <- 0.037433

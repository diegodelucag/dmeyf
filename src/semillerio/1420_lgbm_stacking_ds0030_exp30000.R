...
kexperimento  <- 30000 #NA si se corre la primera vez, un valor concreto si es para continuar procesando

kscript       <- "1420_lgbm"

karchivo_dataset   <-  "./datasets/dataset_stackingv0030.csv"

kfecha_cutoff  <- 202001  #toma todos los meses a partir del cutoff
ktrain_desde   <- 202001
ktrain_hasta   <- 202009
...
#                          lambda_l2= 0.0,         #por ahora, lo dejo fijo
                          max_bin= 1023,            #MAX BIN extremo, para  German y Daiana

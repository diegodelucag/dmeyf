...
x  <- list()
x$gleaf_size   <- 49  
x$gnum_leaves  <-  0.490633822095892
x$learning_rate <-  0.165067292528706
x$feature_fraction <-  0.429564446720785
x$num_iterations  <- 137
x$lambda_l1 <- 3.1024103954
x$lambda_l2 <- 19.8112285688604
x$min_gain_to_split <- 0.0421104399146075 

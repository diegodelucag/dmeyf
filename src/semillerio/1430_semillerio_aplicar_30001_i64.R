...
x  <- list()
x$gleaf_size   <- 49  
x$gnum_leaves  <-  0.45773601037101
x$learning_rate <-  0.187686053532152
x$feature_fraction <-  0.622529884303186
x$num_iterations  <- 90
x$lambda_l1 <- 0.122462534118058
x$lambda_l2 <- 9.68583528978173
x$min_gain_to_split <-  1.16554966214457

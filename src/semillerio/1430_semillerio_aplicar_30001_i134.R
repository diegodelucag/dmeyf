...
karch_dataset  <- "./datasets/dataset_stackingv0030.csv.gz"
ksalida  <- "semillerio_30001_i134" 

kcantidad_semillas  <- 20

#ATENCION
#aqui deben ir los mejores valores que salieron de la optimizacion bayesiana
x  <- list()
x$gleaf_size   <-   47
x$gnum_leaves  <- 0.512335408000367
x$learning_rate <-  0.185838197443678
x$feature_fraction <-  0.701043485479036
x$num_iterations  <- 133
x$lambda_l1 <- 5.85089733382667
x$lambda_l2 <- 16.8707054017294
x$min_gain_to_split <-  0.349814269425184

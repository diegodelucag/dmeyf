...
#ganancia 5963750  ( sobre la mitad de 202011 )
#hiperparametros encontrados en la iteracion bayesiana 82 de un total de 300
param_ganadores  <- list( "learning_rate"= 0.0695489019909315, 
                          "feature_fraction"= 0.770771520830994 ,
                          "min_data_in_leaf"= 4648 ,
                          "num_leaves"= 701,
                          "num_iterations"= 206 ,
                          "lambda_l1"= 30.790086749522,
                          "lambda_l2"= 21.1331955384463,
                          "ratio_corte"=  0.046107303356682)

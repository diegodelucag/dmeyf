...
#ganancia  5385000  ( sobre la mitad de 202011 )
#hiperparametros encontrados en la iteracion bayesiana 91 de un total de 300
param_ganadores  <- list( "learning_rate"= 0.0953823285424896, 
                          "feature_fraction"= 0.914429428975494,
                          "min_data_in_leaf"= 4372,
                          "num_leaves"= 140,
                          "num_iterations"= 210,
                          "ratio_corte"= 0.0412785686190823,
                          "max_depth"=  6,
                          "lambda_l1"= 3, 
                          "lambda_l2"= 37
                        )

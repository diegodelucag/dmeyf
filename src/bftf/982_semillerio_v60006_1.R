...
#ganancia 5743750  ( sobre la mitad de 202011 )
#hiperparametros encontrados en la iteracion bayesiana 38 de un total de 300
param_ganadores  <- list( "learning_rate"= 0.0968914420441064, 
                          "feature_fraction"= 0.70624281184387 ,
                          "min_data_in_leaf"= 7137 ,
                          "num_leaves"= 107,
                          "num_iterations"= 221 ,
                          "lambda_l1"= 58.5634186132942,
                          "lambda_l2"= 199.818765841116,
                          "ratio_corte"= 0.0492539311926222  )

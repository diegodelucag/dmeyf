...
kgen_mes_desde   <- 201901  #desde donde voy a entrenar (venia con 201901)
...
param_ganadores  <- list( "learning_rate"= 0.0333065894067651, 
                          "feature_fraction"= 0.762687404043713 ,
                          "min_data_in_leaf"= 1717 ,
                          "num_leaves"= 844,
                          "num_iterations"= 425 ,
                          "lambda_l1"= 7.27919758495372,
                          "lambda_l2"= 45.8737570346674,
                          "ratio_corte"= 0.0387930673763317,
                          "min_gain_to_split"=0)

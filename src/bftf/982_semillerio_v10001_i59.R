...
param_ganadores  <- list( "learning_rate"=0.0559489802286932 , 
                          "feature_fraction"= 0.371953391156826,
                          "min_data_in_leaf"= 3010 ,
                          "num_leaves"= 788,
                          "num_iterations"= 173 ,
                          "lambda_l1"= 11.8560063812535,
                          "lambda_l2"= 0.451971837474901,
                          "ratio_corte"= 0.0318098031135801,
                          "min_gain_to_split"= 0.0334873757165695)

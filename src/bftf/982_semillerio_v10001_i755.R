...
param_ganadores  <- list("num_iterations"= 3174 ,
                          "learning_rate"= 0.0247793871175055, 
                          "feature_fraction"= 0.799131075841078,
                          "min_data_in_leaf"=  7269,
                          "num_leaves"= 266,
                          "lambda_l1"= 18.2022970385195,
                          "lambda_l2"= 25.187464863112,
                         "min_gain_to_split"=  0.0305712895115484,
                          "ratio_corte"= 0.0359137952753302 
                          )

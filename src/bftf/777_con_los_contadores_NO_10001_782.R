...
param_ganadores  <- list( "learning_rate"= 0.0233397788582049, 
                          "feature_fraction"= 0.253287106477419,
                          "min_data_in_leaf"=  6441,
                          "num_leaves"= 143,
                          "num_iterations"= 259 ,
                          "lambda_l1"= 4.76135546565408,
                          "lambda_l2"= 22.7444142850604,
                          "ratio_corte"= 0.0331276889921284,
                          "min_gain_to_split"=0.0202456139109643  )

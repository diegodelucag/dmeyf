...
kexperimento  <- 5001520202

kscript         <- "982_epic"
karch_dataset   <- "./datasets/dataset_epic_v951_0000.csv.gz"  #el dataset que voy a utilizar
...
#ganancia 5653750  ( sobre la mitad de 202011 )
#hiperparametros encontrados en la iteracion bayesiana 320 de un total de 324
param_ganadores  <- list( "learning_rate"= 0.0305816190121383, 
                          "feature_fraction"= 0.471448021243738 ,
                          "min_data_in_leaf"= 1844 ,
                          "num_leaves"= 706,
                          "num_iterations"= 201 ,
                          "lambda_l1"= 10.8271965762997,
                          "lambda_l2"= 3.55657163913458,
                          "ratio_corte"= 0.0365921016293842,
                          "min_gain_to_split"=9)

...
#ganancia  6012500  ( sobre la mitad de 202011 )
#hiperparametros encontrados en la iteracion bayesiana 189 de un total de 300
param_ganadores  <- list( "learning_rate"= 0.0983221218269318, 
                          "feature_fraction"= 0.268308925198228,
                          "min_data_in_leaf"= 1963,
                          "num_leaves"= 136,
                          "num_iterations"= 248,
                          "ratio_corte"= 0.0384164762789452,
                          "max_depth"=   12,
                          "lambda_l1"= 3, 
                          "lambda_l2"= 119
)

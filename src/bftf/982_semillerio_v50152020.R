...
param_ganadores  <- list( "learning_rate"= 0.0635487233380882, 
                          "feature_fraction"= 0.645557356632168 ,
                          "min_data_in_leaf"= 1457 ,
                          "num_leaves"= 891,
                          "num_iterations"= 59 ,
                          "lambda_l1"= 8.41642830418574,
                          "lambda_l2"= 9.78920985818318,
                          "ratio_corte"= 0.038876754286862,
                          "min_gain_to_split"=4)

...
kgen_mes_desde   <- 202001  #desde donde voy a entrenar (venia con 201901)
...
dir.create( paste0( "./work/E__",  kexperimento, "/" ) )     #creo carpeta del experimento dentro de work

kresultados  <- paste0("./work/E__",  kexperimento, "/E",  kexperimento, "_", kscript, ".txt" )  #archivo donde dejo el resultado
...
#Estos hiperparametros salieron de la optimizacion bayesiana del script 
#hiperparametros encontrados en la iteracion bayesiana 

param_ganadores  <- list("num_iterations"= 222 ,
                          "learning_rate"= 0.0203552876884369, 
                          "feature_fraction"= 0.244830483264337,
                          "min_data_in_leaf"=  6707,
                          "num_leaves"= 189,
                          "lambda_l1"= 1.93438227415734,
                          "lambda_l2"= 26.7050664052399,
                         "min_gain_to_split"=  0.0982008265708763,
                          "ratio_corte"= 0.0352689022935506 
                          )

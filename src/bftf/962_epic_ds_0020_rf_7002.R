...
kexperimento  <- 7002   #NA si se corre la primera vez, un valor concreto si es para continuar procesando
...
hs <- makeParamSet( 
  ...
  makeNumericParam("bagging_fraction", lower=    0.5  , upper=    0.99)
)

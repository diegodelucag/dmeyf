...
kgen_mes_hasta   <- 201812  #hasta donde voy a entrenar
...
param_ganadores  <- list( "learning_rate"= 0.0948301830091892, 
                          "feature_fraction"= 0.883940451949822 ,
                          "min_data_in_leaf"= 395 ,
                          "num_leaves"= 604,
                          "num_iterations"= 32 ,
                          "lambda_l1"= 82.1093623354881,
                          "lambda_l2"= 67.4675080399783,
                          "ratio_corte"= 0.0427359936186738,
                          "min_gain_to_split"=1)

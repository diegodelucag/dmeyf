...
#                        lambda_l2= 0.0,         #por ahora, lo dejo fijo
                        max_bin= 511,            #por ahora, lo dejo fijo
...
param_ganadores  <- list( "num_iterations"= 325 ,
                          "learning_rate"= 0.0200747230625591,
                          "feature_fraction"= 0.121183485771116,
                          "min_data_in_leaf"=  972,
                          "num_leaves"= 880,
                          "lambda_l1"= 3.79237030222421,
                          "lambda_l2"= 89.652856148569,
                          "min_gain_to_split"= 0.00113804381734566,
                          "ratio_corte"= 0.0369324170879267   
                          )

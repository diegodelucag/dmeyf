...
param_ganadores  <- list( "num_iterations"= 268,
                          "learning_rate"= 0.0200079243545526,
                          "feature_fraction"= 0.204328558080039,
                          "min_data_in_leaf"= 3923 ,
                          "num_leaves"= 637,
                          "lambda_l1"= 0.475782346958043,
                          "lambda_l2"= 21.7055231290539,
                          "min_gain_to_split"= 0.115321993410712,
                          "ratio_corte"= 0.0362538042119115 
)

...
param_ganadores  <- list("num_iterations"= 158 ,
                          "learning_rate"= 0.0203140347719221, 
                          "feature_fraction"= 0.383481841529116,
                          "min_data_in_leaf"=  3979,
                          "num_leaves"= 330,
                          "lambda_l1"= 1.11201859731492,
                          "lambda_l2"= 6.71614129209365,
                         "min_gain_to_split"=  2.93567814444689,
                          "ratio_corte"= 0.0360360298936117 
                          )

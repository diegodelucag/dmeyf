...
kscript         <- "982_epic"
karch_dataset   <- "./datasets/dataset_epic_v951_0002.csv.gz"  #el dataset que voy a utilizar
...
param_ganadores  <- list( "learning_rate"= 0.0549518557106703, 
                          "feature_fraction"= 0.454203100953344,
                          "min_data_in_leaf"= 4400,
                          "num_leaves"= 651,
                          "num_iterations"= 382,
                          "ratio_corte"= 0.04662616220197,
                          "max_depth"=  12,
                          "lambda_l1"= 20, 
                          "lambda_l2"= 39
                        )

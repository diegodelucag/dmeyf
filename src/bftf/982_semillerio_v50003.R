...
kscript         <- "982_epic"
karch_dataset   <- "./datasets/dataset_epic_v951_0003.csv.gz"  #el dataset que voy a utilizar
...
#ganancia  5336250  ( sobre la mitad de 202011 )
#hiperparametros encontrados en la iteracion bayesiana 215 de un total de 300
param_ganadores  <- list( "learning_rate"= 0.0793870625243709, 
                          "feature_fraction"= 0.855871028544381,
                          "min_data_in_leaf"= 4489,
                          "num_leaves"= 338,
                          "num_iterations"= 390,
                          "ratio_corte"= 0.0384583197342104,
                          "max_depth"=  11,
                          "lambda_l1"= 7, 
                          "lambda_l2"= 117
                        )

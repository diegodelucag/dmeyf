...
################################################################################################
# Agrega 2 palancas más:
  
# sample: 
# un número decimal que establece el tamaño de la muestra (entre 0 y 1.0). Si se pone en 1.0 o más se deshabilita

# stratifiedcolumns: una lista con columnas para estratificar, 
# lo mínimo es poner la clase ternaria y foto mes, pero aquí depende de los experimentos.
# Usa la función "particionar" como la escribió la cátedra. 
# Está pensado para tener un dataset secundario para hacer pruebas locales
# (por limitaciones principalmente de memoria) y luego subir los cambios a los scripts a Github y nuestras VMs. Una pequeña ayuda a la productividad.

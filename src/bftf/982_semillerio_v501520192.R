...
param_ganadores  <- list( "learning_rate"= 0.0306688081261838, 
                          "feature_fraction"= 0.281004766554978 ,
                          "min_data_in_leaf"= 403 ,
                          "num_leaves"= 798,
                          "num_iterations"= 157 ,
                          "lambda_l1"= 31.7417167142523,
                          "lambda_l2"= 3.36510140721114,
                          "ratio_corte"= 0.0455236256008732,
                          "min_gain_to_split"=6)

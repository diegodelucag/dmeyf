...
param_ganadores  <- list( "learning_rate"= 0.0868992384040995, 
                          "feature_fraction"= 0.926967107874735 ,
                          "min_data_in_leaf"= 3055 ,
                          "num_leaves"= 954,
                          "num_iterations"= 87 ,
                          "lambda_l1"= 14.4033834764042,
                          "lambda_l2"= 144.060896627282,
                          "ratio_corte"= 0.0451700099587424,
                          "min_gain_to_split"=0.426137824400169)

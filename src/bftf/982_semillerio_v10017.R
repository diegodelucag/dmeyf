...
kscript         <- "982_epic"
karch_dataset   <- "./datasets/datasets-dataset_epic_v951_0009.csv.gz"  #el dataset que voy a utilizar
...
param_ganadores  <- list( "learning_rate"= 0.0973339821725711, 
                          "feature_fraction"= 0.651666032952629 ,
                          "min_data_in_leaf"= 249 ,
                          "num_leaves"= 530,
                          "num_iterations"= 151 ,
                          "max_depth"= -1,  
                          "ratio_corte"= 0.0360062932556719 )

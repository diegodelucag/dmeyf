...
param_ganadores  <- list("num_iterations"= 193 ,
                          "learning_rate"= 0.0250046807750671, 
                          "feature_fraction"= 0.19769141535884,
                          "min_data_in_leaf"=  4593,
                          "num_leaves"= 881,
                          "lambda_l1"= 7.3886591016161,
                          "lambda_l2"= 0.396358565366021,
                         "min_gain_to_split"=  0.946087457897731,
                          "ratio_corte"= 0.0364195936932208 
                          )

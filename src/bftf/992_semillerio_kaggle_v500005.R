...
kexperimento  <- 5000005

kscript         <- "992_epic"
karch_dataset   <- "./datasets/dataset_epic_v951_0005.csv.gz"  #el dataset que voy a utilizar
...
#ganancia  6488750  ( sobre la mitad de 202011 )
#hiperparametros encontrados en la iteracion bayesiana 139 de un total de 300
param_ganadores  <- list( "learning_rate"= 0.0762198673680425, 
                          "feature_fraction"= 0.130437877293187,
                          "min_data_in_leaf"= 1745,
                          "num_leaves"= 896,
                          "num_iterations"=306 ,
                          "ratio_corte"= 0.0429272007565297,
                          "max_depth"= 11  ,
                          "lambda_l1"= 0, 
                          "lambda_l2"= 49
)

...
kexperimento  <- 20001   #NA si se corre la primera vez, un valor concreto si es para continuar procesando

kscript         <- "847_epic_stacking"

karch_dataset    <- "./datasets/dataset_stacking2_v0014.csv.gz"   #este dataset se genero en el script 812_dataset_epic.r

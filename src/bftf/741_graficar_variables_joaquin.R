...
# Les dejo un script simple que gráfica las distribuciones en Boxplot por categoría. 
# Puede usarse para graficar el dataset que quieran. 
# Ojo! Hay muchos outliers y hace que los gráficos pesen mucho, 
# si quieren eliminarlos del gráfico usen el parametro outlier.shape = NA 
# dentro de la llamada a `geom_boxplot().

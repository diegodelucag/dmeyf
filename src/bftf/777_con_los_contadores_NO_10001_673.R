...
param_ganadores  <- list( "learning_rate"= 0.0218665600549766, 
                          "feature_fraction"= 0.41207870551603,
                          "min_data_in_leaf"=  4950,
                          "num_leaves"= 912,
                          "num_iterations"= 138 ,
                          "lambda_l1"= 7.51862179695781,
                          "lambda_l2"= 24.5930808970997,
                          "ratio_corte"= 0.03581544558186,
                          "min_gain_to_split"=0.271831224196804)

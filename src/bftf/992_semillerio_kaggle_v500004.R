...
kscript         <- "992_epic"
karch_dataset   <- "./datasets/dataset_epic_v951_0004.csv.gz"  #el dataset que voy a utilizar
...
#ganancia  5837500  ( sobre la mitad de 202011 )
#hiperparametros encontrados en la iteracion bayesiana 9 de un total de 300
param_ganadores  <- list( "learning_rate"= 0.0587069865269586, 
                          "feature_fraction"= 0.997509212130015,
                          "min_data_in_leaf"= 2653,
                          "num_leaves"= 553,
                          "num_iterations"= 375,
                          "ratio_corte"= 0.0369101118893994,
                          "max_depth"=  12,
                          "lambda_l1"= 7, 
                          "lambda_l2"= 49
)

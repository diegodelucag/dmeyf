...
param_ganadores  <- list( "num_iterations"= 91 ,
                          "learning_rate"= 0.0449309396514611,
                          "feature_fraction"= 0.375639710407502,
                          "min_data_in_leaf"=  3010,
                          "num_leaves"= 329,
                          "lambda_l1"= 9.95154585713843,
                          "lambda_l2"= 5.12446109570539,
                          "min_gain_to_split"= 0.0119723621215222,
                          "ratio_corte"= 0.0367483626642139  
                          )

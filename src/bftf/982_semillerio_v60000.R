...
param_ganadores  <- list( "learning_rate"= 0.0589848546770139, 
                          "feature_fraction"= 0.692462266155524,
                          "min_data_in_leaf"= 201 ,
                          "num_leaves"= 1006,
                          "num_iterations"= 326 ,
                          "lambda_l1"= 14.2867946083352,
                          "lambda_l2"= 11.1162964427637,
                          "ratio_corte"= 0.0363912530441114 )
